...
CREATE TABLE `pcms_columns` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='栏目';
...
INSERT INTO `pcms_columns` VALUES ('25', '25', '5', '1', 'service', 'service/service', '公司服务', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('26', '26', '5', '1', 'project', 'service/project', '服务项目', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('27', '27', '5', '1', 'process', 'service/process', '服务流程', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('28', '28', '6', '1', 'guarantee', 'guarantee/guarantee', '环保保障', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('29', '29', '6', '1', 'quality', 'guarantee/quality', '环保质量', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('30', '30', '6', '1', 'construction', 'guarantee/construction', '施工保障', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('31', '31', '6', '1', 'standard', 'guarantee/standard', '施工标准', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('32', '32', '7', '1', 'design', 'design/design', '设计理念', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('33', '33', '7', '1', 'five', 'design/five', '五大风格', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('34', '34', '9', '1', 'contact', 'contact/contact', '联系我们', '', '', '', '1', '', '', '1', '1');
INSERT INTO `pcms_columns` VALUES ('36', '36', '8', '1', 'recruit', 'recruit/recruit', '招贤纳士', '', '', '', '6', '', '', '1', '1');
...
CREATE TABLE `pcms_feedback` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='反馈';

-- ----------------------------
-- Records of pcms_feedback
-- ----------------------------
INSERT INTO `pcms_feedback` VALUES ('7', '3', '0', null, null, '1', null, '晓明', '1', null, '1', null, '0', null, '1453101077', null, null);
INSERT INTO `pcms_feedback` VALUES ('8', '2', '0', null, null, 'aaaa', null, 'aaa', 'a', null, 'a', null, '0', null, '1453101231', null, null);
...
CREATE TABLE `pcms_log` (
  ...
  `timeline` int(11) NOT NULL COMMENT '时间线',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=1996 DEFAULT CHARSET=utf8 COMMENT='操作日志';
...
INSERT INTO `pcms_log` VALUES ('1940', 'login', '/admin/index.php/login?url=http://localhost:85/admin/index.php?', 'login', 'manager ID 1: 登录成功！', '1', '0.0.0.0', '1453005047');
INSERT INTO `pcms_log` VALUES ('1941', 'page', '/admin/index.php/page/edit?c=25', 'update', '更新数据id:26', '1', '0.0.0.0', '1453005769');
INSERT INTO `pcms_log` VALUES ('1942', 'page', '/admin/index.php/page/edit?c=26', 'update', '更新数据id:27', '1', '0.0.0.0', '1453005793');
INSERT INTO `pcms_log` VALUES ('1943', 'page', '/admin/index.php/page/edit?c=27', 'update', '更新数据id:28', '1', '0.0.0.0', '1453005809');
INSERT INTO `pcms_log` VALUES ('1944', 'page', '/admin/index.php/page/edit?c=27', 'update', '更新数据id:28', '1', '0.0.0.0', '1453006912');
INSERT INTO `pcms_log` VALUES ('1945', 'page', '/admin/index.php/page/edit?c=26', 'update', '更新数据id:27', '1', '0.0.0.0', '1453006930');
INSERT INTO `pcms_log` VALUES ('1946', 'page', '/admin/index.php/page/edit?c=28', 'update', '更新数据id:29', '1', '0.0.0.0', '1453007011');
INSERT INTO `pcms_log` VALUES ('1947', 'page', '/admin/index.php/page/edit?c=30', 'update', '更新数据id:30', '1', '0.0.0.0', '1453007072');
INSERT INTO `pcms_log` VALUES ('1948', 'page', '/admin/index.php/page/edit?c=29', 'update', '更新数据id:31', '1', '0.0.0.0', '1453007085');
INSERT INTO `pcms_log` VALUES ('1949', 'page', '/admin/index.php/page/edit?c=31', 'update', '更新数据id:32', '1', '0.0.0.0', '1453007133');
INSERT INTO `pcms_log` VALUES ('1950', 'page', '/admin/index.php/page/edit?c=32', 'update', '更新数据id:33', '1', '0.0.0.0', '1453007204');
INSERT INTO `pcms_log` VALUES ('1951', 'page', '/admin/index.php/page/edit?c=33', 'update', '更新数据id:34', '1', '0.0.0.0', '1453007239');
INSERT INTO `pcms_log` VALUES ('1952', 'page', '/admin/index.php/page/edit?c=34', 'update', '更新数据id:35', '1', '0.0.0.0', '1453007306');
INSERT INTO `pcms_log` VALUES ('1953', 'page', '/admin/index.php/page/edit?c=34', 'update', '更新数据id:35', '1', '0.0.0.0', '1453009232');
INSERT INTO `pcms_log` VALUES ('1954', 'cases', '/admin/index.php/cases/flag?c=21', 'flag', '推荐数据ID：2为1', '1', '0.0.0.0', '1453010052');
INSERT INTO `pcms_log` VALUES ('1955', 'cases', '/admin/index.php/cases/flag?c=21', 'flag', '推荐数据ID：1为1', '1', '0.0.0.0', '1453010386');
INSERT INTO `pcms_log` VALUES ('1956', 'cases', '/admin/index.php/cases/flag?c=22', 'flag', '推荐数据ID：3为1', '1', '0.0.0.0', '1453010389');
INSERT INTO `pcms_log` VALUES ('1957', 'cases', '/admin/index.php/cases/flag?c=23', 'flag', '推荐数据ID：4为1', '1', '0.0.0.0', '1453010392');
INSERT INTO `pcms_log` VALUES ('1958', 'cases', '/admin/index.php/cases/flag?c=24', 'flag', '推荐数据ID：5为1', '1', '0.0.0.0', '1453010396');
INSERT INTO `pcms_log` VALUES ('1959', 'cases', '/admin/index.php/cases/audit?c=21', 'audit', '审核数据ID：2为0', '1', '0.0.0.0', '1453011042');
INSERT INTO `pcms_log` VALUES ('1960', 'login', '/admin/index.php/login?url=http://localhost:85/admin/index.php/cases/index/21?', 'login', 'manager ID 1: 登录成功！', '1', '0.0.0.0', '1453011069');
INSERT INTO `pcms_log` VALUES ('1961', 'cases', '/admin/index.php/cases/audit?c=21', 'audit', '审核数据ID：2为1', '1', '0.0.0.0', '1453011071');
INSERT INTO `pcms_log` VALUES ('1962', 'cases', '/admin/index.php/cases/flag?c=21', 'flag', '推荐数据ID：2为0', '1', '0.0.0.0', '1453011073');
INSERT INTO `pcms_log` VALUES ('1963', 'cases', '/admin/index.php/cases/flag?c=21', 'flag', '推荐数据ID：2为1', '1', '0.0.0.0', '1453011084');
INSERT INTO `pcms_log` VALUES ('1964', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：15为1', '1', '0.0.0.0', '1453011438');
INSERT INTO `pcms_log` VALUES ('1965', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：14为1', '1', '0.0.0.0', '1453011438');
INSERT INTO `pcms_log` VALUES ('1966', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：13为1', '1', '0.0.0.0', '1453011439');
INSERT INTO `pcms_log` VALUES ('1967', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：12为1', '1', '0.0.0.0', '1453011441');
INSERT INTO `pcms_log` VALUES ('1968', 'article', '/admin/index.php/article/flag?c=18', 'flag', '推荐数据ID：2为1', '1', '0.0.0.0', '1453011446');
INSERT INTO `pcms_log` VALUES ('1969', 'article', '/admin/index.php/article/flag?c=18', 'flag', '推荐数据ID：1为1', '1', '0.0.0.0', '1453011447');
INSERT INTO `pcms_log` VALUES ('1970', 'article', '/admin/index.php/article/flag?c=20', 'flag', '推荐数据ID：6为1', '1', '0.0.0.0', '1453011646');
INSERT INTO `pcms_log` VALUES ('1971', 'article', '/admin/index.php/article/flag?c=20', 'flag', '推荐数据ID：5为1', '1', '0.0.0.0', '1453011647');
INSERT INTO `pcms_log` VALUES ('1972', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：11为1', '1', '0.0.0.0', '1453012319');
INSERT INTO `pcms_log` VALUES ('1973', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：9为1', '1', '0.0.0.0', '1453012328');
INSERT INTO `pcms_log` VALUES ('1974', 'columns', '/admin/index.php/columns/edit/35', 'update', '更新数据id:35', '1', '0.0.0.0', '1453032486');
INSERT INTO `pcms_log` VALUES ('1975', 'columns', '/admin/index.php/columns/delete?ids=35', 'delete', '删除数据id:35', '1', '0.0.0.0', '1453032871');
INSERT INTO `pcms_log` VALUES ('1976', 'feedback', '/admin/index.php/feedback/delete?ids=6', 'delete', '删除数据id:6', '1', '0.0.0.0', '1453102909');
INSERT INTO `pcms_log` VALUES ('1977', 'feedback', '/admin/index.php/feedback/sortid?ids=7%2C8&sort=2%2C3&sortby=desc', 'sort', '对数据排序:ID: [7,8]顺序改为[3,2]', '1', '0.0.0.0', '1453102926');
INSERT INTO `pcms_log` VALUES ('1978', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：10为1', '1', '0.0.0.0', '1453114331');
INSERT INTO `pcms_log` VALUES ('1979', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：8为1', '1', '0.0.0.0', '1453114333');
INSERT INTO `pcms_log` VALUES ('1980', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：7为1', '1', '0.0.0.0', '1453114334');
INSERT INTO `pcms_log` VALUES ('1981', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：4为1', '1', '0.0.0.0', '1453114335');
INSERT INTO `pcms_log` VALUES ('1982', 'article', '/admin/index.php/article/flag?c=19', 'flag', '推荐数据ID：3为1', '1', '0.0.0.0', '1453114337');
INSERT INTO `pcms_log` VALUES ('1983', 'columns', '/admin/index.php/columns/edit/36', 'update', '更新数据id:36', '1', '0.0.0.0', '1453114768');
INSERT INTO `pcms_log` VALUES ('1984', 'recruit', '/admin/index.php/recruit/create?c=36', 'create', '添加数据id:1', '1', '0.0.0.0', '1453114946');
INSERT INTO `pcms_log` VALUES ('1985', 'recruit', '/admin/index.php/recruit/show_ajax?c=36', 'show', '显示数据ID：1为0', '1', '0.0.0.0', '1453114951');
INSERT INTO `pcms_log` VALUES ('1986', 'recruit', '/admin/index.php/recruit/show_ajax?c=36', 'show', '显示数据ID：1为1', '1', '0.0.0.0', '1453114952');
INSERT INTO `pcms_log` VALUES ('1987', 'recruit', '/admin/index.php/recruit/audit?c=36', 'audit', '审核数据ID：1为1', '1', '0.0.0.0', '1453114955');
INSERT INTO `pcms_log` VALUES ('1988', 'recruit', '/admin/index.php/recruit/audit?c=36', 'audit', '审核数据ID：1为0', '1', '0.0.0.0', '1453114957');
INSERT INTO `pcms_log` VALUES ('1989', 'recruit', '/admin/index.php/recruit/create?c=36', 'create', '添加数据id:2', '1', '0.0.0.0', '1453115078');
INSERT INTO `pcms_log` VALUES ('1990', 'recruit', '/admin/index.php/recruit/sortid?c=36&ids=1%2C2&sort=1%2C2&sortby=desc', 'sort', '对数据排序:ID: [1,2]顺序改为[2,1]', '1', '0.0.0.0', '1453115110');
INSERT INTO `pcms_log` VALUES ('1991', 'recruit', '/admin/index.php/recruit/audit?c=36', 'audit', '审核数据ID：1为1', '1', '0.0.0.0', '1453115110');
INSERT INTO `pcms_log` VALUES ('1992', 'recruit', '/admin/index.php/recruit/audit?c=36', 'audit', '审核数据ID：2为1', '1', '0.0.0.0', '1453115110');
INSERT INTO `pcms_log` VALUES ('1993', 'recruit', '/admin/index.php/recruit/edit/1?c=36', 'update', '更新数据id:1', '1', '0.0.0.0', '1453123948');
INSERT INTO `pcms_log` VALUES ('1994', 'recruit_apply', '/admin/index.php/recruit_apply/sortid?ids=245%2C244&sort=%2C&sortby=desc', 'sort', '对数据排序:ID: [245,244]顺序改为[,]', '1', '0.0.0.0', '1453208792');
INSERT INTO `pcms_log` VALUES ('1995', 'login', '/admin/index.php/login?url=http://localhost:85/admin/index.php?', 'login', 'manager ID 1: 登录成功！', '1', '0.0.0.0', '1453290461');
...
-- ----------------------------
INSERT INTO `pcms_manager` VALUES ('1', 'admin', '超级用户', 'ed01a71f99b2d1bb54201d0be5d01889', '1', '123@abc.com', '', '', '', '1', '0', '0', '0.0.0.0', '1376471117', '1453290461', '1', '1389317880');
...
CREATE TABLE `pcms_manager_purview` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=200 DEFAULT CHARSET=utf8 COMMENT='用户组权限';
...
INSERT INTO `pcms_manager_purview` VALUES ('140', 'page', 'index', '25', '572c2b012731079c6dd52ef2aeda21c2', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('141', 'page', 'create', '25', '2553f73a031d56c054b65ebda5e2e109', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('142', 'page', 'edit', '25', 'e62503bd66ab0424aeb484f3478e297b', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('143', 'page', 'delete', '25', '199f745f65ed815f77bb7857583d442a', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('144', 'page', 'audit', '25', 'a69d2941fa1418b5e3f18e9462f8306e', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('145', 'page', 'index', '26', 'ac27755640c5653919bcabcfdecea051', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('146', 'page', 'create', '26', 'dae18aa6e604e59d03a0c53f7cc333c5', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('147', 'page', 'edit', '26', '093b9049ba11c684043556bb59a12eb5', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('148', 'page', 'delete', '26', 'b5dc0945f94a22b427b024cb1f682638', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('149', 'page', 'audit', '26', '7204834ccec1f71f3999e8d4916ea13c', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('150', 'page', 'index', '27', '2306012ac7f9d26755a91b6eb1538d62', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('151', 'page', 'create', '27', '186809ea86d6b21d3a02b86a8c1a6b89', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('152', 'page', 'edit', '27', '03ac7ee245cfa7aa6ba4f3e4ab30d178', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('153', 'page', 'delete', '27', 'd2f87b22eccf2509a9d835f0bb5f0b22', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('154', 'page', 'audit', '27', '03625f75a49d05890eeb151644b63a56', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('155', 'page', 'index', '28', 'ca03f159e5e570feaa3cf960ac6a29e4', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('156', 'page', 'create', '28', 'ee7111a4cf26824f94c3b5bc85d2da5a', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('157', 'page', 'edit', '28', 'b4798aa2fb0b493c7928e9256181d73b', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('158', 'page', 'delete', '28', '7f17c5907ef15086d24220a34579bc48', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('159', 'page', 'audit', '28', '7a4329e99c0173026e66b2f6ff70324b', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('160', 'page', 'index', '29', '05a7b1a9c2cd26861b8a87aafb000d8c', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('161', 'page', 'create', '29', '017c1d6fae3be3a95a26f99a9b5c7a88', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('162', 'page', 'edit', '29', '73fe92a083eab23335362e5fdc0879f3', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('163', 'page', 'delete', '29', 'eae953d32c1420712ec8f08228474c6e', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('164', 'page', 'audit', '29', 'c3974e7ef3e4641be2048448719a86c7', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('165', 'page', 'index', '30', 'e0fd975319c874c5f02f802b3201949b', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('166', 'page', 'create', '30', '29d0934ab8155adbbd6b94df4bac3ea5', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('167', 'page', 'edit', '30', '7c6f9430eb960f52be2eb420645bdcc1', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('168', 'page', 'delete', '30', '16bacb294eeaa66b0e326abd2fdb7910', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('169', 'page', 'audit', '30', 'a6ee4e3e7f6e8f858b3ad8b34071bbb8', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('170', 'page', 'index', '31', '42addba1d5649b3bc02dfebfe5833622', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('171', 'page', 'create', '31', '6370b2e913e91163efa997f10fed6b0c', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('172', 'page', 'edit', '31', 'f96f8e3599fd3be147af77f0f638d166', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('173', 'page', 'delete', '31', '5a8c2356ee4f7cf22b9d8a94458dbce0', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('174', 'page', 'audit', '31', '615e298980da384bea6e6d7aac0f8131', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('175', 'page', 'index', '32', '3dee839e4c32f0d926823a50e7f5dc22', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('176', 'page', 'create', '32', 'e539ddd1769bbd0a212275353b11cd78', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('177', 'page', 'edit', '32', '7e08efc1106244abe505a6d1b27662be', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('178', 'page', 'delete', '32', '0d5216f77d2caba37b983a3c103ac3ef', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('179', 'page', 'audit', '32', 'a5aac2448a15b0be86c0ebe402694c4d', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('180', 'page', 'index', '33', '6659e411bab6cd5cd42f896e468cc180', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('181', 'page', 'create', '33', 'c55f5848a7d1f5c98e14453504a10815', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('182', 'page', 'edit', '33', '08adf7fe2e452f3321770215b9e2417e', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('183', 'page', 'delete', '33', '65fc72d8f9a6854ec53fa53ca58b085d', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('184', 'page', 'audit', '33', 'c0bb5a4aa6971529c267e51694fc3ec3', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('185', 'page', 'index', '34', '36bcc6a7b0352f242c83e90f5d9e17df', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('186', 'page', 'create', '34', 'f85f41279e4fc46bafd341ed5c9bc59b', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('187', 'page', 'edit', '34', '419a12d56315590115e9dad24bb0b93f', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('188', 'page', 'delete', '34', '957a89d3746f2a9f05855451f0efc29c', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('189', 'page', 'audit', '34', 'ee36456d2a6f22f497eb0b6a22434cc7', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('190', 'page', 'index', '35', 'c44b4f7565d1eecc1cd7a8bbd8966154', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('191', 'page', 'create', '35', 'd6ff0334b8b8c5614cf82e26fd8e6957', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('192', 'page', 'edit', '35', 'c6116c9d404655772f4340d20569796b', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('193', 'page', 'delete', '35', '2a50246781f025c741b6b4dc74f46d76', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('194', 'page', 'audit', '35', '54a62fdd2c32024a35b82776f959f396', '审核', '1');
INSERT INTO `pcms_manager_purview` VALUES ('195', 'page', 'index', '36', 'a35b5fcff88ea7561f8a447daddb9270', '查看', '0');
INSERT INTO `pcms_manager_purview` VALUES ('196', 'page', 'create', '36', 'aca659045e9995bb283f5a6113a6cdff', '创建', '1');
INSERT INTO `pcms_manager_purview` VALUES ('197', 'page', 'edit', '36', 'b73bd461a9be23a18097a9b4e3a543bb', '编辑', '1');
INSERT INTO `pcms_manager_purview` VALUES ('198', 'page', 'delete', '36', '2691a75c1a5c8b434fda6ea65cd1af6d', '删除', '1');
INSERT INTO `pcms_manager_purview` VALUES ('199', 'page', 'audit', '36', 'a02c039ab524ede366216fb67ef0479d', '审核', '1');
...
CREATE TABLE `pcms_page` (
  ...
  `attachment` tinytext COMMENT '附件',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=38 DEFAULT CHARSET=utf8 COMMENT='单页表';
...
INSERT INTO `pcms_page` VALUES ('26', '25', '0', '16', '0', '公司服务', '', '', '', '<p><strong>多、快、好、省—天盛装饰为您打造全方位一站式家装服务！</strong> </p><p>&nbsp;<strong>1&gt;30天无理由退货</strong>   凡是客户在心安家居体验馆看到的材料工艺家具配饰等，支付定金之日起30天内，如对产品感到不满意、不合适、不喜欢（不在30天无理由退货范围之内的除外)，可至心安进行无理由退换货，不需作出任何解释。</p><p>&nbsp;<strong>2&gt;售出产品负全责</strong>    凡在心安选购的产品，并持有心安装饰统一合同单据，或者有确实证据证明为在天盛家居体验馆内选购的产品，客户因产品质量问题(产品质量问题认定以国家相关法律法规为依据)而产生疑议与投诉，在国家法律规定的三包期限内，天盛装饰负责全程处理，并承担相应责任。</p><p>&nbsp;<strong>3&gt;倡导绿色环保政策</strong>   致力于倡导绿色环保，做行业领跑者，实行商户准入资质审查制度，力争达到所有材料工艺绿色环保，从健康、美观、实用角度出发，努力为客户营造温馨、和谐家园。郑重承诺装修不达标全额退款，另外支付5％赔偿金。</p><p>&nbsp;<strong>4&gt;送货安装准时达</strong>    在心安家居体验馆经营的所有家具建材商家都必须按合同约定时间完成送货和安装任务否则就要承担违约责任。 </p><p>&nbsp;<strong>5&gt;家居顾问全程导购</strong>   专业的家居顾问24时随时为您服务，根据您的生活需要，为您量身推荐家居采购方案为您省时省心。</p><p>&nbsp;<strong>6&gt;设计师免费咨询</strong>   所有心安设计师可以根据您的需求为您提供免费的家装设计,家具设计咨询服务。</p>', null, null, null, '1453005494', null);
INSERT INTO `pcms_page` VALUES ('27', '26', '0', '17', '0', '服务项目', '', '', '', '<p><strong>多、快、好、省—天盛装饰为您打造全方位一站式家装服务！</strong> </p><p>&nbsp;<strong>1&gt;30天无理由退货</strong> &nbsp; 凡是客户在心安家居体验馆看到的材料工艺家具配饰等，支付定金之日起30天内，如对产品感到不满意、不合适、不喜欢（不在30天无理由退货范围之内的除外)，可至心安进行无理由退换货，不需作出任何解释。</p><p>&nbsp;<strong>2&gt;售出产品负全责</strong> &nbsp; &nbsp;凡在心安选购的产品，并持有心安装饰统一合同单据，或者有确实证据证明为在天盛家居体验馆内选购的产品，客户因产品质量问题(产品质量问题认定以国家相关法律法规为依据)而产生疑议与投诉，在国家法律规定的三包期限内，天盛装饰负责全程处理，并承担相应责任。</p><p>&nbsp;<strong>3&gt;倡导绿色环保政策</strong> &nbsp; 致力于倡导绿色环保，做行业领跑者，实行商户准入资质审查制度，力争达到所有材料工艺绿色环保，从健康、美观、实用角度出发，努力为客户营造温馨、和谐家园。郑重承诺装修不达标全额退款，另外支付5％赔偿金。</p><p>&nbsp;<strong>4&gt;送货安装准时达</strong> &nbsp; &nbsp;在心安家居体验馆经营的所有家具建材商家都必须按合同约定时间完成送货和安装任务否则就要承担违约责任。</p><p>&nbsp;<strong>5&gt;家居顾问全程导购</strong> &nbsp; 专业的家居顾问24时随时为您服务，根据您的生活需要，为您量身推荐家居采购方案为您省时省心。</p><p>&nbsp;<strong>6&gt;设计师免费咨询</strong> &nbsp; 所有心安设计师可以根据您的需求为您提供免费的家装设计,家具设计咨询服务。</p><p></p>', '', '', null, '1453005498', null);
INSERT INTO `pcms_page` VALUES ('28', '27', '0', '18', '0', '服务流程', '', '', '', '<p><strong>第1步 设计咨询</strong> 　　</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>量房 　　</p></li><li><p>设计方案 　　</p></li><li><p>方案确认 ,沟通客户需求 　　</p></li><li><p>签订合同 　　</p></li><li><p>交纳首期款&nbsp; &nbsp;<strong>　　</strong></p></li></ol><p><strong>第2步 施工前期 775影视</strong> 　　</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>设计、施工现场交底，办理相关手续 　　</p></li><li><p>填写专业服务流程单，现场工程量核准单 　　</p></li><li><p>进行拆除施工，布置现场 　　</p></li><li><p>施工材料进场、验收 　　</p></li><li><p>橱柜、卫浴柜、家具、成品木门测量 　　</p></li><li><p>根据专业服务流程单选购产品，并参考 　　</p></li><li><p>施工时间送货 　　</p></li><li><p>隐蔽工程施工、验收，交纳合同中期款&nbsp; &nbsp;<strong>　　</strong></p></li></ol><p><strong>第3步 施工中期&nbsp;</strong>　　</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>水电管线完成 　　</p></li><li><p>瓷砖进场，瓦工基层处理，厨房墙砖铺贴基本完成 　　</p></li><li><p>橱柜、卫浴柜、家具复测（特殊情况下需进行木门复测） 　　</p></li><li><p>木工收口 　　</p></li><li><p>木工制作类吊顶材料进场、施工 　　</p></li><li><p>五金类材料进场、安装 　　</p></li><li><p>定制式产品签约 　　</p></li><li><p>油工基层处理 　　</p></li><li><p>中期验收，核算增减项并交纳增减项款&nbsp; &nbsp;<strong>　　</strong></p></li></ol><p><strong>第4步 施工后期&nbsp;</strong>　　</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>油工施工 　　</p></li><li><p>非木工制作类吊顶材料进场、施工 　　</p></li><li><p>地板、壁纸、散热器类产品铺装 　　</p></li><li><p>木门、橱柜、卫浴柜、家具等安装 　　</p></li><li><p>洁具、灯具、电工电料产品进场安装 　　</p></li><li><p>自检清理&nbsp; &nbsp;<strong>　　</strong></p></li></ol><p><strong>第5步 竣工验收&nbsp;</strong>　　</p><ol class=\" list-paddingleft-2\" style=\"list-style-type: decimal;\"><li><p>自检清理 　　</p></li><li><p>交纳尾款，办理保修&nbsp; &nbsp;<strong>　　</strong></p></li></ol><p><strong>第6步 售后服务&nbsp;</strong></p>', '', '', null, '1453005500', null);
...
INSERT INTO `pcms_page` VALUES ('29', '28', '0', '19', '0', '环保保障', '', '', '', '<p><strong>环境质量保障:</strong>　　</p><p>决定工程品质的第三要素是环境，整洁、健康和人性的施工环境能够保障家装工程生态健康。生态型的施工环境，能够有效缓解疲劳，使施工人员神经放松，提高现场工作效率和工作质量。 环保、整洁、以人为本，和谐之美，细节处彰显优质工程。&nbsp;　　</p><p>施工区和生活区严格区分：避免交叉&quot;感染&quot;。 　　</p><p>辅材摆放处：正确码放，杜绝脏乱，提高效率。 　　</p><p>甲供材料摆放处:一目了然，查缺补漏。&nbsp;　　</p><p>木工操作台：精确制作，避免现场临时拼错，为木工质量助力。 　　</p><p>更衣柜：衣有所归，鞋有所放。 　　</p><p>饮水机：涓涓水流，保证健康。 　　</p><p>水泥灰槽：杜绝水泥&quot;赖&quot;在地上。 　　</p><p>临时坐便器：统一配置的临时洁具，保证施工环境整洁卫生。 　　</p><p>工具箱：工具摆放有序，提高工作效率。现场杜绝明火，灭火器以防万一：为了保证施工现场的安防患于未然，杜绝火灾隐患，工程要求在施工现场至少要配置两个灭火器，复式和跃层每层至少配置1-2个。 　　</p><p>施工铭牌、施工手册：两项举措监督施工进度。 　　</p><p>施工基准线：精细施工，必不可少。 　　</p><p>先行成品保护：不让客户的成品受半点&quot;伤害&quot;。 　　</p><p>垃圾及时清理制度：杜绝垃圾&quot;藏身&quot;地下。 　　</p><p>现场警告和温馨提示：监督提醒，严以律己。 　　</p><p>确保整个施工过程和竣工后的管理服务完美无缺。</p>', '', '', null, '1453006925', null);
INSERT INTO `pcms_page` VALUES ('30', '30', '0', '20', '0', '施工保障', '', '', '', '<p>对于每一项施工都建立了完善的系统管理监督机制，施工过程中的每一个环节都管理到位，力求确保工程质量从开始到结束的完美。&nbsp;<strong>　　</strong></p><p><strong>专业的施工团队</strong> 　　</p><p>专业的施工团队,规范的管理制度，先进的施工技能&nbsp;<strong>　　</strong></p><p><strong>全程有效的检验机制</strong> 　　</p><p>项目经理、巡检员、设计师定期巡检 　　</p><p>总经理不定期抽检 　　</p><p>客服专员回访&nbsp;<strong>　　</strong></p><p><strong>设计图纸标准化机制</strong> 　　</p><p>设计图纸的标准化规范化程度决定施工标准化和精准化的程度。为此心安装饰对于工程图纸制定了严格的标准。这些标准化的图纸能够确保施工按既定的规范和标准严格 执行，为客户的装修做保障&nbsp;<strong>　　</strong></p><p><strong>ERP质量信息登记机制</strong> 　　</p><p>心安装饰ERP系统，针对家装行业的特点，在售前咨询、工程实施及售后服务等几个方面加强了管理和跟踪，大大提高了工作精准度及服务质量和工作效率，实现了企业以客户为 本的价值理念&nbsp;<strong>　　</strong></p><p><strong>8小时快速反应机制</strong> 　　</p><p>心安装饰客服中心将由专人在8小时内就投诉内容建立详细的档案及解决方案 　　</p><p>保证在24小时内圆满解决</p>', '', '', null, '1453007038', null);
INSERT INTO `pcms_page` VALUES ('31', '29', '0', '21', '0', '环保质量', '', '', '', '<p><strong>环境质量保障:</strong>　　</p><p>决定工程品质的第三要素是环境，整洁、健康和人性的施工环境能够保障家装工程生态健康。生态型的施工环境，能够有效缓解疲劳，使施工人员神经放松，提高现场工作效率和工作质量。 环保、整洁、以人为本，和谐之美，细节处彰显优质工程。&nbsp;　　</p><p>施工区和生活区严格区分：避免交叉&quot;感染&quot;。 　　</p><p>辅材摆放处：正确码放，杜绝脏乱，提高效率。 　　</p><p>甲供材料摆放处:一目了然，查缺补漏。&nbsp;　　</p><p>木工操作台：精确制作，避免现场临时拼错，为木工质量助力。 　　</p><p>更衣柜：衣有所归，鞋有所放。 　　</p><p>饮水机：涓涓水流，保证健康。 　　</p><p>水泥灰槽：杜绝水泥&quot;赖&quot;在地上。 　　</p><p>临时坐便器：统一配置的临时洁具，保证施工环境整洁卫生。 　　</p><p>工具箱：工具摆放有序，提高工作效率。现场杜绝明火，灭火器以防万一：为了保证施工现场的安防患于未然，杜绝火灾隐患，工程要求在施工现场至少要配置两个灭火器，复式和跃层每层至少配置1-2个。 　　</p><p>施工铭牌、施工手册：两项举措监督施工进度。 　　</p><p>施工基准线：精细施工，必不可少。 　　</p><p>先行成品保护：不让客户的成品受半点&quot;伤害&quot;。 　　</p><p>垃圾及时清理制度：杜绝垃圾&quot;藏身&quot;地下。 　　</p><p>现场警告和温馨提示：监督提醒，严以律己。 　　</p><p>确保整个施工过程和竣工后的管理服务完美无缺。</p><p></p>', '', '', null, '1453007077', null);
INSERT INTO `pcms_page` VALUES ('32', '31', '0', '22', '0', '施工标准', '', '', '', '<p><strong>电路标准施工</strong> 　　</p><p>标准水电路施工，先放线后施工，竣工线路做到横平竖直、电管在上水管在下。提倡厨卫水、电路顶面施工，既不费钱又能及时解决处理滴漏跑冒现象。使用安全无卤阻燃电线，取代黑胶布强弱线管有效间隔，采用电磁屏蔽技术，避免强电路和弱电路之间的干扰，保证良好的视频和音频效果。&nbsp;<strong>　　</strong></p><p><strong>轻钢龙骨标准施工</strong> 　　</p><p>轻钢龙骨取代木龙骨，全面升级，采用专用连接件 　　杜绝吊顶变形、开裂、虫蛀等现象，延长使用时间。&nbsp;<strong>　　</strong></p><p><strong>防水施工</strong> 　　</p><p>采用法国（韦伯）双组份防水灰浆，防水灰浆用于迎水及背水面防水工程，可密封发丝细的裂缝，可以省略防水完成后的拉毛处理。&nbsp;<strong>　　</strong></p><p><strong>材料码放</strong> 　　</p><p>整齐有序的材料码放会提高施工人员的施工质量要求，重要材料物流按照标准配额配送，杜绝偷工减料、以次充好。&nbsp;<strong>　　</strong></p><p><strong>涂料施工</strong> 　　</p><p>原装丹麦进口涂料，标准施工工艺，加上专属的调色设备，会为您涂刷出色彩亮丽的家。&nbsp;<strong>　　</strong></p><p><strong>现场勘察放线标识工艺</strong> 　　</p><p>施工现场进行精确勘测后，采用精确放线标示技术进行细致标注使得精细施工有据可依。&nbsp;<strong>　　</strong></p><p><strong>施工流程手册</strong> 　　</p><p>现场技术交底流程单，水电预算建立书面报告，各施工环节验收报告，使复杂的装修变成流程化，并明确客户经理岗位职责，留存联系方式。 　　</p><p><br/></p><p>客服人员24小时接听投诉、报修电话，2小时内安排施工人员联系客户，非紧急情况48小时上门维修。</p>', '', '', null, '1453007088', null);
INSERT INTO `pcms_page` VALUES ('33', '32', '0', '23', '0', '设计理念', '', '', '', '<p><strong>设计理念的诠释: 自然和谐、人文关怀、安全低耗</strong> 　　</p><p>“自然一词有两个主要的含义：一是指的自然物的集合，二是指“本性”。而我们在此所提倡的健康家居设&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>和谐</strong> 　　</p><p>中国古人关于“和谐”的概念中，首先就是把“和”与“利”联系在一起。古人说，利为义之和。也就是说，万物之间当然有利益冲突，只有消弭冲突，各自节制，不相争夺，才能达到和谐， 因此，“和谐”之“和”首先是调和、和解不同利益之“和”。&nbsp;<strong>　</strong></p><p><strong>　</strong></p><p><strong>自然和谐</strong> 　　</p><p>通过自然物特有的属性遵循自然界的规律和法则，调和室内人文与物件，精神与物体，空间与结构，色调与采光，等多方面的冲突已达到心灵感受上的和谐舒适的健康居室环境。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>人文</strong> 　　</p><p>人类的文化轨迹，人类现状文化背景，和通过改创未来人类文化的发展方向。它包括(历史的，民族的，区域的，个体的，集体的，宗教的，信仰的等)。而我们在这里只研究人类在室内环境的人文学科。&nbsp;<strong>　</strong></p><p><strong>　</strong></p><p><strong>关怀</strong> 　　</p><p>关怀本是动词，但我们也经常用于形容词的范畴，如关怀式家装，它表示的是一种行为上的状态和程度，关怀代表着，服务，爱心，温馨、恬静、优雅、和谐、奋发向上。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>人文关怀</strong> 　　</p><p>一个蕴含人文关怀的家居环境，会给人一个温馨、恬静、优雅、和谐、奋发向上的精神空间，从这个意义上来说，人文关怀与其说是民族文化的积淀，不如说是时代对室内设计的召唤。室内环境设计呼唤人文关怀！以人为本，关爱弱势人群，构筑无障碍生活。人文关怀设计倡导的是一种既与传统文脉相承、又结合现代功能与技术的要求与之相并进 。同时也记载了居住者在精神健康的文明程度的高低。&nbsp;</p><p><strong>　　</strong></p><p><strong>安全</strong> 　　</p><p>从英文SAFETY安全的解释是这样：保险，安全设备，保险装备。安全性在人居生活中体现的是一种生活状态的保障，那么健康家居设计将通过安全设备，安全用料，安全施工，安全的设计手法，便于维护等多方面使得人在任何时间任何状态都处于相对的健康状态。&nbsp;<strong>　</strong></p><p><strong>　</strong></p><p><strong>低耗</strong> 　　</p><p>所谓健康家居的低耗，即是我们通过设计手段追求消耗最小的能源，资源和环境付出，而获取较大的室内环境质量和服务。低耗同时也是住者一种能源的储备。材料的再生和回收性。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>安全低耗</strong> 　　</p><p>通过安全性的设计手段，在长期的居住环境中避免出现安全隐患问题，并达到最小的消耗获取最大的能源储备。体现出健康家居生活保障。我们有义务在更多的设计中找到低耗的每一种可能，不放过每一种低耗材料的替代品。</p>', '', '', null, '1453007138', null);
INSERT INTO `pcms_page` VALUES ('34', '33', '0', '24', '0', '五大风格', '', '', '', '<p>在设计领域，心安更是领衔业界。业之峰的每一个设计风格、每一个设计元素、每一场发布会，都始终代表着业界的最前沿。早在2003年，心安就首次系统地提出室内设计应以人的生活方式为主的理念，以此来提升室内设计文化及发展室内设计潮流。尤其是最近，结合现代都市人的生活特点，心安与国际知名设计机构联合研发出“五大主流风格”，更是成为了设计文化的中坚代表。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>新古典风格</strong> 　　</p><p>新古典主义的设计风格是经过改良的古典主义风格。欧洲文化丰富的艺术底蕴，开放、创新的设计思想及其尊贵的姿容，一直以来颇受大众的喜爱。新古典风格从简单到繁杂、从整体到局部，精雕细琢，镶花刻金都给人一丝不苟的印象。新古典风格一方面保留了材质、色彩的大致风格，可以很强烈地感受传统的历史痕迹与浑厚的文化底蕴，同时又摒弃了过于复杂的肌理和装饰，简化了线条。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>新中式风格</strong> 　　</p><p>新中式风格诞生于中国传统文化复兴的新时期，以含蓄秀美为主要特色。新中式风格表达的是对清雅含蓄、端庄丰华的东方式精神境界的追求。新中式风格通过对传统文化的认识，将现代元素和传统元素结合在一起，明清家具、窗棂、布艺床品相互辉映，以现代人的审美需求来打造富有传统韵味的事物，让传统艺术在当今社会得到合适的体现。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>东南亚风格</strong> 　　</p><p>东南亚风格是东南亚民族岛屿特色及精致文化品位相结合的产物，是一种新兴的居住与休闲相结合的概念。对于追求理想，走在时代最前沿的人来说，东南亚风格不仅仅代表着一种地方风情，而是共同期待和追求的理想归宿。粗犷而狂放的线条，取源于大自然的真实质感，表达舒适、自由、放纵的想法，温馨的家透出高贵、典雅的气质。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>美式风格</strong> 　　</p><p>美式风格由美国西部乡村的生活方式演变而来，它摒弃了过多的繁琐与奢华，兼具古典主义的优美造型与新古典主义的功能配备，既简洁明快，又温暖舒适，强调“回归自然”。美式风格讲求自在、随意不羁的生活方式，没有太多造作的修饰与约束，不经意中也成就了另外一种休闲式的浪漫。美式风格特点：空间要明快光鲜，通常使用大量的石材和木饰面装饰。&nbsp;<strong>　　</strong></p><p><strong><br/></strong></p><p><strong>现代风格</strong> 　　</p><p>现代风格即现代主义风格，提倡突破传统，创造革新，重视功能和空间组织，注重发挥结构本身的形式美。现代主义造型简洁，反对多余装饰，崇尚合理的构成工艺，设计表现得简约而不简单，时尚而又典雅，整体空间表现得深沉、雅致又不失灵性。</p>', '', '', null, '1453007142', null);
INSERT INTO `pcms_page` VALUES ('35', '34', '0', '25', '0', '联系我们', '', '', '', '<p>装饰工程有限公司</p><p><br/></p><p>地址：</p><p><br/></p><p>电话：0731-3338888 &nbsp;</p><p><br/></p><p>全国服务热线：4000- 000-00 &nbsp;/ 0731-3339999</p><p><br/></p><p>联系人：18733338888</p><p><br/></p><p>乘车路线：BRT方向前行200米园丁路即是。</p><p><br/></p><p>公司传真：0731-3338888（座机暂时有故障，请拔打400电话或手机）</p><p><br/></p><p>邮箱：&nbsp;&nbsp; 网址：</p>', '', '', null, '1453007244', null);
INSERT INTO `pcms_page` VALUES ('36', '35', '0', '26', '0', null, null, null, null, null, null, null, null, '1453007309', null);
INSERT INTO `pcms_page` VALUES ('37', '36', '0', '27', '0', null, null, null, null, null, null, null, null, '1453007311', null);
...
CREATE TABLE `pcms_recruit` (
  ...
  `requirement` text,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='人才招聘';

-- ----------------------------
-- Records of pcms_recruit
-- ----------------------------
INSERT INTO `pcms_recruit` VALUES ('1', '2', '36', '0', '室内设计师', null, null, null, '<p>1、参与公司装饰工程项目的设计管理，提出设计意见；</p><p>2、负责装修施工质量管理、招投标管理；</p><p>3、参加方案设计、初步设计、施工图设计审核；制定项目设计计划及设计任务书；</p><p>4、参加市场调研，编制本系统相关技术经济方案；</p><p>5、负责对项目进行跟踪和监督；</p><p>6、设计师应协助材料部对装修项目材料进行确认工作；</p><p>7、负责案例，技术及资源的整理；</p><p>8、配合项目经理制定工作进度。</p>', '1453046400', '1461945600', '0', '1', '0', '1', '1', null, null, null, null, null, null, null, '上海', '无', '1', '2', '0', '18', '35', '本科', '无', '3年', '<p></p><p>1、装饰设计、室内设计等相关专业本科以上学历；</p><p>2、两年以上相关工作经验，有大中型项目设计经验者优先考虑；</p><p>3、有较强的视觉搭配能力，能熟练操作AutoCAD 、PowerPoint、Photoshop 等软件；</p><p>4、学习能力强、热爱设计工作、有创新精神；</p><p>5、善于沟通，表达能力强，有团队精神；</p><p>6、富有创意及执行力，有责任感、表达能力强。</p>');
INSERT INTO `pcms_recruit` VALUES ('2', '1', '36', '0', '报价师兼业务部经理', null, null, null, '<p>待遇：参照心安中山大区套档、计提。</p>', '1453046400', '1460822400', '0', '1', '0', '1', '1', null, null, null, null, null, null, null, '北京', '经理', '0', '业务部', '0', '18', '35', '本科', '报价师', '3年', '<p>1、熟练掌握CAD、word、excel等相关软件；</p><p>2、形象端正，热情大方，施工工艺熟练，沟通能力及组织能力强；</p><p>3、对待工作细致、踏实、诚实，职业素养、道德修养良好，有上进心、责任心、有组织、有纪律；</p><p>4、外省优先，年纪在30岁以上有工作经验者优先考虑</p>');
...
CREATE TABLE `pcms_recruit_apply` (
  ...
  `timeline` int(11) DEFAULT NULL COMMENT '发布/修改时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=246 DEFAULT CHARSET=utf8 COMMENT='在线应聘';

-- ----------------------------
-- Records of pcms_recruit_apply
-- ----------------------------
INSERT INTO `pcms_recruit_apply` VALUES ('244', '0', '小李', '', '室内设计师', null, '福建', null, '本科', '个人简历', '家庭情况', '工作经历', null, '158', null, null, null, null, null, null, null, null, '1453208257');
INSERT INTO `pcms_recruit_apply` VALUES ('245', '0', '小黄', '90', '报价师兼业务部经理', null, '浙江', null, '大专', '个人', '家庭', '工作', null, '158', null, null, null, null, null, null, null, '::1', '1453208447');
...
-- ----------------------------
INSERT INTO `pcms_sessions_adminer` VALUES ('7096a2498ce5f93f8f4be3404e5295a7', '::1', 'Mozilla/5.0 (Windows NT 6.3; Win64; x64; Trident/7.0; rv:11.0) like Gecko', '1453290461', 'a:5:{s:3:\"mid\";s:1:\"1\";s:5:\"uname\";s:5:\"admin\";s:8:\"nickname\";s:12:\"超级用户\";s:8:\"login_ip\";s:7:\"0.0.0.0\";s:3:\"gid\";s:1:\"1\";}');
