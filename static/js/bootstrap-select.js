    ...
    Selectpicker.prototype = {
        ...
        createLi: function(template) {
            ...
            this.$element.find('option').each(function(i,e){
                ...
                if($(this).attr('data-option-more') != undefined && $(this).attr('data-option-depth') != undefined){
                    var more = parseInt($(this).attr('data-option-more'));
                    var depth = parseInt($(this).attr('data-option-depth'));
                    _data.push({more:more,depth:depth});
                }else{
                    _data.push({more:-1,depth:-1});
                } 
            ...
            this.$element.find('option').each(function(i,e) {
                ...
                if ( _data != [] && _data[i].depth >=0  ) {
                    bstree = ' bs-tree';

                    var more = _data[i].more;
                    var depth = _data[i].depth;
                   ...
                   if (ehaveNext){
                    ...
                    if (more>0) {
                        data_icon_more += '<i class="fa fa-plus-square"></i> &nbsp;';
                    }else{
                        data_icon_more += '&nbsp';
                    };
                    ...
                    if ($(this).index() == 0) {
                        if ($(this)[0].index != 0) {
                            _liA.push(
                                '<div class="div-contain"><div class="divider"></div></div>'+
                                '<dt>'+$(this).parent().attr('label')+'</dt>'+
                                '<a tabindex="-1" href="#" class="opt '+optionClass+'">'+data_icon_more+$(this).text()+'</a>'
                                );
                        } else {
                            _liA.push(
                                '<dt>'+$(this).parent().attr('label')+'</dt>'+
                         ...
                         _liA.push('<a tabindex="-1" href="#" class="opt '+optionClass+'">'+data_icon_more+$(this).text()+'</a>');
                    }
                } else if ($(this).data('divider') == true) {
                    _liA.push('<div class="div-contain"><div class="divider"></div></div>');
                } else {                    
                    _liA.push('<a tabindex="-1" href="#" class="'+optionClass+'">'+data_icon_more+$(this).text()+'</a>');
                }
            });
