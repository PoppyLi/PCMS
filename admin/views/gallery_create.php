...
<div class="boxed">
	...
	<?php echo form_open(current_urlc(),array("class"=>"form-horizontal","id"=>"frm-create")); ?>
		...
		<div class="boxed-inner seamless">
			...
			<div class="control-group">			
				<label for="words" class="control-label">banner文字：</label>
				<div class="controls">
					<input type="text" name="words" id="words" value="<?php echo set_value('words'); ?>"  placeholder="">
					<span class="help-inline"></span>
				</div>
			</div>	
			<?php } ?>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<div class="btn-group">
						...
						<input type="hidden" name="photo" class="form-upload" value="<?php echo set_value('photo') ?>"  data-more="1">
...
<?php echo static_file('adminer/gallery.js'); ?>
<?php include_once 'inc_ui_media.php'; ?>
<?php if ($p = set_value('photo')): ?>
<script type="text/javascript">
	var coltypes_photos = <?php echo json_encode(list_upload($p)) ?>;
