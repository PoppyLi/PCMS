    ...
    <?php echo form_open(current_urlc(), array('class' => 'form-horizontal', 'id' => 'frm-edit')); ?>
        ...
        <div class="boxed-inner seamless">  
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="addr" name="addr" x-webkit-speech value="<?php echo set_value('addr',$it['addr']); ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="postcode" name="postcode" x-webkit-speech value="<?php echo set_value('postcode',$it['postcode']); ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="tel" name="tel" x-webkit-speech value="<?php echo set_value('tel',$it['tel']); ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="fox" name="fox" x-webkit-speech value="<?php echo set_value('fox',$it['fox']); ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="pointlong" name="pointlong" x-webkit-speech value="<?php echo set_value('pointlong',$it['pointlong']); ?>">
                    <input type="text" id="pointlat" name="pointlat" x-webkit-speech value="<?php echo set_value('pointlat',$it['pointlat']); ?>">
                </div>
            </div>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" id="maptitle" name="maptitle" x-webkit-speech value="<?php echo set_value('maptitle',$it['maptitle']); ?>">
                </div>
            </div>
        ...
        <div class="control-group">
            <label class="control-label" for="egf">地图内容：</label>
            <div class="controls">
                <textarea id="" name="content" class="input-xxlarge" style="width:650px; height:100px;"><?php echo set_value('content',$it['content']) ?></textarea>
            </div>
        </div>
...
<script type="text/javascript">
    var store_photos = <?php echo json_encode($ps) ?>;
