...
<html>
	<head>
		...
		echo static_file('jquery.pnotify.css');
		echo static_file('bootstrap-select.css');
		echo static_file('adminer/ui.css');
		echo static_file('adminer/sidebar.css');

		if (isset($_COOKIE['theme']) and strtolower($_COOKIE['theme']) != 'default' ) {
			echo static_file('adminer/theme-'.strtolower($_COOKIE['theme']).'.css');
		}

		echo static_file('bootstrap.js'); 
		echo static_file('jquery.validate.js');
		echo static_file('jquery.validate.lang.cn.js');
		echo static_file('jquery.pnotify.js');
		echo static_file('jquery-ui-1.10.3.custom.js');
		echo static_file('jquery.cookie.js');
		echo static_file('bootstrap-bootbox.js');
		echo static_file('bootstrap-select.js');
			...
			<div class="navbar-inner">
				<div class="container">
					<ul class="nav-logo pull-left">
						<li>
							<a href="http://" target="_blank"><img src=" <?php echo static_file('img/logo.png') ?>"></a>
						</li>
						<li>
