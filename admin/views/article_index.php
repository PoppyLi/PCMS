...
<table class="table table-striped table-hover select-list">
	...
	<tbody class="sort-list">
		...
		<tr data-id="<?php echo $v['id'] ?>" data-sort="<?php echo $v['sort_id'] ?>">
			...
			<?php if ($this->cid == 23 && !$this->ccid): ?>
			<td> 
			<a href="<?php echo site_url('article2/index?c=23&cc='.$v['id']) ?>"> 基本信息 </a>
			|<a href="<?php echo site_url('article/index?c=23&cc='.$v['id']) ?>"> 大事记录 </a>
<!-- 			| <a href="<?php echo site_url('links/index?c=23&cc='.$v['id']) ?>"> 伪子栏目链接 </a>
			| <a href="<?php echo site_url('lists/index?c=23&cc='.$v['id']) ?>"> 伪子栏目清单 </a> -->
			| <a href="<?php echo site_url('product/index?c=23&cc='.$v['id']) ?>"> 通知 </a>
			</td>
			<?php endif ?>
