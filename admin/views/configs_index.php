...
<?php echo static_file('adminer/configs_index.js'); ?>
	...
	<div class="boxed-inner">
		...
		<?php foreach ($upload as $v):?>
			...
			<?php if ($v['key'] == "watermark"): ?>
				...
				<?php if ($up_watermark = one_upload($v['value'])): ?>
					<?php if (file_exists(UPLOAD_PATH.$up_watermark['url'])): ?>
						文件丢失,请重新上传...
					<?php endif ?>
				<script type="text/javascript">
					var watermark = <?php echo json_encode($up_watermark) ?>;
					media.show(watermark,'watermark');
				</script>
				<?php endif ?>
			<?php else: ?>
